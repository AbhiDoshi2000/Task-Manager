...
const data = [
    {
      ...
      text: "Well done on the work done so far!. The task priority is set a normal priority, so check and act accordingly. The task date is Thu Feb 29 2024. Thank you!!!",
      task: null,
      notiType: "alert",
      isRead: [],
    ...
    <>
        <Popover className='relative'>
            <PopoverButton className='inline-flex items-center outline-none'>
                <div className="w-8 h-8 flex items-center justify-center text-gray-800 realtive">
